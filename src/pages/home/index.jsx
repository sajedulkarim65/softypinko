              ...
              <div class="row">
                ...
                >
                  <div class="features-small-item">
                    <div class="icon">
                      <i>
                        <img src={featuredItem01} alt=""></img>
                      </i>
                    </div>
            ...
            <div class="row">
              <div class="col-lg-2 col-md-3 col-sm-6 col-6">
                <a href="#" class="mini-box">
                  <i>
                    <img src={workProcessItem} alt=""></img>
                  </i>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
              <div class="team-item">
                <div class="team-content">
                  <i>
                    <img src={testimonialIcon} alt=""></img>
                  </i>
                  <p>
